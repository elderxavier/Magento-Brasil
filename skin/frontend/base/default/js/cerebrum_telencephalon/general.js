...
function validaCPFouCNPJ(cpf,pType){
...
function ItemInstallments_CheckoutTelencephalon(event, element){
	...
	URLSAVE += 'payment_method/' + payment_method + '/';
